...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<activesupport>, "= 7.0.5.1")
      s.add_development_dependency(%q<actionpack>, "= 7.0.5.1")
      ...
      s.add_dependency(%q<activesupport>, "= 7.0.5.1")
      s.add_dependency(%q<actionpack>, "= 7.0.5.1")
